            ...
            <div class="card-body" style="overflow-x:auto;">
                <table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								<td>Vegetables</td>
								<td><a href="/products/download-cat/1">Click to Generate</a></td>
						    </tr>
						    <tr>
						        <td>Dairy</td>
								<td><a href="/products/download-cat/2">Click to Generate</a></td>
							</tr>
							<tr>
						        <td>Fruits</td>
								<td><a href="/products/download-cat/3">Click to Generate</a></td>
							</tr>
							<tr>
						        <td>Meat,Fish & Egg</td>
								<td><a href="/products/download-cat/5">Click to Generate</a></td>
							</tr>
                            <tr>
    						    <td>Pickles</td>
    						    <td><a href="/products/download-cat/10">Click to Generate</a></td>
    						</tr>
    						<tr>
    						    <td>Bakery</td>
    						    <td><a href="/products/download-cat/14">Click to Generate</a></td>
    						</tr>
						</tbody>
